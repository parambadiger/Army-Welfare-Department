    ...
    <div class="container"><!-- Start Header Container -->
        ...
        <header id="header" class="clearfix">
            ...
            <div class="menu-and-contact-wrap">
                ...
                ?>
                            <li class="<?php echo ($page_name=='updatecompany.php')?'current-menu-item current_page_item':'';?>"><a href="updatecompany.php">Home</a></li>
                            <li class="<?php echo ($page_name=='view.php'||$page_name=='updatevacancy.php')?'current-menu-item current_page_item':'';?>"><a href="view.php">Posted Jobs</a></li>
                            
                            <li class="<?php echo ($page_name=='Vacancy.php')?'current-menu-item current_page_item':'';?>"><a href="Vacancy.php">Create Vacancy</a></li>
                            
                            <li class="<?php echo ($page_name=='updatecompanypassword.php')?'current-menu-item current_page_item':'';?>"><a href="updatecompanypassword.php">Update Password</a></li>
                            <li class="<?php echo ($page_name=='seekerlogout.php')?'current-menu-item current_page_item':'';?>"><a href="companylogout.php">Logout</a></li>
